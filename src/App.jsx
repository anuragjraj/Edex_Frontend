...
const ALL_CHAPTERS = {
  ...
  "Class 3": {
    "English":     ["Good Morning","The Magic Garden","Bird Talk","Nina and the Baby Sparrows","Little by Little","The Enormous Turnip","Sea Song","A Little Fish Story","Don't Tell","How Creatures Move","The Ship of the Desert","The Balloon Man","Trains","The Kite","The Butterfly","Nine Gold Medals"],
    ...
    "Hindi":       ["कक्षा","जिम कार्बेट","चाँद वाली अम्मा","मन करता है","बहादुर बित्तो","चिड़िया","टिपटिपवा","बंदर बाँट","अकबर और बीरबल","क्योंकि","जब मुझे साँप ने काटा","मिर्च का मज़ा","सबसे अच्छा पेड़"],
  ...
  "Class 4": {
    "English":     ["Wake Up!","Neha's Alarm Clock","Noses","The Little Fir Tree","Run!","Nasruddin's Aim","Why?","Alice in Wonderland","Don't be Afraid of the Dark","Helen Keller","The Donkey","Hiawatha","A Watering Rhyme","The Giving Tree","Books","Going to Buy a Book","The Milkman's Cow","The Scholar's Mother Tongue","Pinocchio","Plants in Winter","Gulliver's Travels"],
    ...
    "Hindi":       ["मन के भोले-भाले बादल","जैसा सवाल वैसा जवाब","नूरी","थप्प रोटी थप्प दाल","नाम","नाना नानी","बचपन के दिन","वह सुबह कभी तो आएगी","स्वतंत्रता की ओर","थोड़ी धरती पाऊँ","पढ़क्कू की सूझ","सुनीता की पहिया कुर्सी","हुदहुद","मुफ़्त ही मुफ़्त"],
  ...
  "Class 5": {
    "English":     ["Ice Cream Man","Wonderful Waste!","Teamwork","Flying Together","My Shadow","Robinson Crusoe","Crying","My Elder Brother","The Little Bully","Rip Van Winkle","Class Discussion","The Lazy Frog","Who Will be Ningthou?","Topsy-turvy Land","Gulliver's Travels","Beauty","Tansen","The Mirror of Beauty","The Friendly Mongoose","The Shepherd's Treasure","Across the Wall","No Men are Foreign","The Talkative Barber"],
    ...
    "Hindi":       ["राख की रस्सी","फसलों के त्योहार","खिलौनेवाला","नन्हा फ़नकार","जहाँ चाहो वहाँ जाओ","चिट्ठी का सफ़र","डाकिए की कहानी","वे दिन भी क्या दिन थे","एक माँ की बेबसी","क्या हुआ जब जाना","चावल की रोटियाँ","गुरु और चेला","स्वामी की दादी","बिशन की दिलेरी","हम होंगे कामयाब","पानी रे पानी"],
  ...
  "Class 6": {
    ...
    "English":        ["Who Did Patrick's Homework?","A Different Kind of School","How the Dog Found Himself a New Master!","The Shepherd's Treasure","The Old-Clock Shop","Tansen","The Friendly Mongoose","The Quarrel","Beauty","The Kite","A House, A Home","The Wonderful Words"],
  ...
  "Class 7": {
    ...
    "Science":        ["Nutrition in Plants","Nutrition in Animals","Fibre to Fabric","Heat","Acids Bases and Salts","Physical and Chemical Changes","Weather Climate and Adaptations of Animals","Wind Storms and Cyclones","Soil","Respiration in Organisms","Transportation in Animals and Plants","Reproduction in Plants","Motion and Time","Electric Current and its Effects","Light","Water: A Precious Resource","Forests: Our Lifeline","Wastewater Story"],
    "English":        ["Three Questions","A Gift of Chappals","Gopal and the Hilsa Fish","The Ashes that Made Trees Bloom","Quality","Expert Detectives","The Invention of Vita-Wonk","Fire: Friend and Foe","A Bicycle in Good Repair","The Story of Cricket","Meadow Surprises","Garden Snake"],
